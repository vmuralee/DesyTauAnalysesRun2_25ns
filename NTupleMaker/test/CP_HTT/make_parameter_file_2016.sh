...
#   else 
#       if [[ $CHANNELL == "tt"]]; then
# 	  ./split_filelist.sh analysisMacroSynch_${CHANNEL}_16_data.conf Tau_Run2016B 4
# 	  ./split_filelist.sh analysisMacroSynch_${CHANNEL}_16_data.conf Tau_Run2016C 4
# 	  ./split_filelist.sh analysisMacroSynch_${CHANNEL}_16_data.conf Tau_Run2016D 4
# 	  ./split_filelist.sh analysisMacroSynch_${CHANNEL}_16_data.conf Tau_Run2016E 4
# 	  ./split_filelist.sh analysisMacroSynch_${CHANNEL}_16_data.conf Tau_Run2016F 4
# 	  ./split_filelist.sh analysisMacroSynch_${CHANNEL}_16_data.conf Tau_Run2016G 4
# 	  ./split_filelist.sh analysisMacroSynch_${CHANNEL}_16_data.conf Tau_Run2016H 4
# 	  # Embedded
# 	  ./split_filelist.sh analysisMacroSynch_${CHANNEL}_16_embedded.conf EmbeddedTauTau_Run2016B 4
# 	  ./split_filelist.sh analysisMacroSynch_${CHANNEL}_16_embedded.conf EmbeddedTauTau_Run2016C 4
# 	  ./split_filelist.sh analysisMacroSynch_${CHANNEL}_16_embedded.conf EmbeddedTauTau_Run2016D 4
# 	  ./split_filelist.sh analysisMacroSynch_${CHANNEL}_16_embedded.conf EmbeddedTauTau_Run2016E 4
# 	  ./split_filelist.sh analysisMacroSynch_${CHANNEL}_16_embedded.conf EmbeddedTauTau_Run2016F 4
# 	  ./split_filelist.sh analysisMacroSynch_${CHANNEL}_16_embedded.conf EmbeddedTauTau_Run2016G 4
# 	  ./split_filelist.sh analysisMacroSynch_${CHANNEL}_16_embedded.conf EmbeddedTauTau_Run2016H 4
#       else	 
...
# ./split_filelist.sh analysisMacroSynch_${CHANNEL}_16_MC_TT_CP5.conf TTTo2L2Nu 10
# ./split_filelist.sh analysisMacroSynch_${CHANNEL}_16_MC_TT_CP5.conf TTToSemiLeptonic 10
# ./split_filelist.sh analysisMacroSynch_${CHANNEL}_16_MC_TT_CP5.conf TTToHadronic 10
